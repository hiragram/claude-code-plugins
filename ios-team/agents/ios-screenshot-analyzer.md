...
【UI要素一覧】
| 要素 | accessibilityIdentifier | ソース位置 |
|------|------------------------|-----------|
| [ボタン名等] | `identifier_value` または **未設定** | ファイル:行番号 |
| ... | ... | ... |
...
**注意**: ソースコード調査が依頼に含まれていない場合や、単純な視覚確認のみの場合は、【画面情報】と【UI要素一覧】セクションは省略可能です。ただし、UI要素について言及する際は可能な限りaccessibility identifierの有無も確認してください。
